    ...
    return {
      ...
      buildAll: async () => {
        ...
        if (packages.components[this.core.src] === '@webcardinal/core') {
          configuration.push(await this.configuration.build(this.core.src, true));

          if (packages['@cardinal/core']) {
            configuration.push(await this.configuration.build(packages['@cardinal/core'].src, false, true));
            components = components.filter(component => packages['@cardinal/core'].src !== component);
          }
        } else {
        ...
        if (this.options[FLAGS.DEVELOPMENT] && packages['@cardinal/core']) {
